...
import { Input, message, Table, Tag, Popconfirm, Icon, Button, Divider } from 'antd'
    ...
    render() {
        return (
            <div className="InvestmentsTable">
                ...
                <Table bordered dataSource={this.state.investments} loading={this.state.loading} pagination={{defaultPageSize: 6}}>
                    <Column
                        title="Username"
                        dataIndex="username"
                        key="username"
                            ...
                            return (
                                <span>
                                    ...
                                    >
                                            <Button
                                                type="link"
                                                style={{ display: banDisplay, color: '#FF5E49', fontSize: 13, padding: 0 }}
                                            >
                                                Забанить
                                            </Button>
                                    </Popconfirm>
